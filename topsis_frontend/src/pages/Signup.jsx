        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4">
            <div className="w-full max-w-md bg-slate-950/80 backdrop-blur-md rounded-2xl border border-slate-800 p-8 shadow-2xl shadow-indigo-900/20">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-slate-400">Join GeoTOPSIS today</p>
                </div>
                ...
                <div className="relative flex items-center py-2 mb-6">
                    ...
                    <span className="flex-shrink-0 mx-4 text-xs text-slate-500 uppercase tracking-wide font-medium">Or continue with email</span>
                    <div className="flex-grow border-t border-slate-800"></div>
                </div>
